...
30 minutes ago
CHANGELOG.md
Initial public release — IAQ Security Patrol v0.4.1
37 minutes ago
CONTRIBUTING.md
Initial public release — IAQ Security Patrol v0.4.1
37 minutes ago
...
Place the iaq-security-patrol directory in wp-content/plugins/.
Activate IAQ Security Patrol in WordPress Admin → Plugins.
Open IAQ Patrol in the WordPress admin menu.
The plugin creates its event and temporary-ban tables on activation.
...
Security reports
Please do not publish exploitable vulnerabilities in a public issue. See SECURITY.md.
